...
*** Introduction
    ...
    + 73: originates from -> originates in
    + 74: or +from+ machine
    + 77: several +key
    + 78: +how we+ managed
    + 80-84: rephrase
...
**** HPL
     ...
     + 135: *MPI* collective
     + 135: overlap efficiently -> efficiently overlap
     ...
     + 169: and hence facilitate partial overlapping -> , hence facilitating the
       partial overlap of
     + 170: 2.2 and 2.1 -> 2.1 and 2.2
     + 188: Remark, try to have DEPTH on the left column with the other
       parameters for the sake of readability
**** Typical runs
...
*** Related Work 
    ...
    + 260: broken ref
    + 262: *s*ligth
    + 270: study direcly -> directly study
    + 275: emulate faithfully -> faithfully emulate
...
*** Conclusions
    + 1127-1128: not the same values as in Fig 6 ??
*** Biblio
    + ya du grattage possible
      + [6] ACM PPoPP
      + [online] ou Available: mais pas les deux
    + [1] Feb 2016 -> Apr 2019, v2.2
    + La ref G5k est pas la bonne (c'est celle pour le cloud ça) 
    + Vous pouvez aussi mettre du 'et al.' de partout, dans une double blind, ça
      peut aider. 
