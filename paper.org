...
their performance is extremely expensive. High-Performance Linpack (HPL),
...
We also leveraged this information on which memory area is private, shared or
...
upgrade of the current machine should be considered. As a future work,
