...
\SI{250}{\gibi\byte} on a system where double-precision floating-point numbers
...
For example, for a matrix of order $N=4,000,000$, it shrinks from \SI{250}{\gibi\byte}
to \SI{0.488}{\gibi\byte}.
