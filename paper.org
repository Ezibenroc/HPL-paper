...
\title{Faithful and Efficient Simulation of\linebreak complex MPI applications}
...
ggsave(filename='figures/validation_performance_simple.pdf', plot=plot)
plot
#+end_src

#+RESULTS:
[[file:/tmp/babel-nl8reK/figureKeHBkz.png]]
