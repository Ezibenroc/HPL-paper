...
\begin{center}
    ...
    \begin{minipage}[t]{0.3\linewidth}
        \includegraphics[width=\linewidth]{figures/node_hours.pdf}
        \label{fig:teaser:node_hours}
        \captionof{figure}{For the largest matrix, simulation is one order of magnitude less expensive than the real execution}
    \end{minipage}
    \hfill
...
repository, no need to download them. They have been dumped by [[https://github.com/Ezibenroc/mpi_calibration/blob/bbf62a227a1744da81f0635a7564262f1c5cf704/dahu/smpi_hpl/hpl_simulation.ipynb][this notebook]]
(cell 2).
...
@mastersthesis{cornebize:hal-01544827,
  ...
  OPTAUTHOR = {Cornebize, Tom},
  OPTURL = {https://hal.inria.fr/hal-01544827},
  OPTSCHOOL = {{Grenoble INP ; Universit{\'e} Grenoble - Alpes}},
  AUTHOR = {Anonymous},
  SCHOOL = {{University of Neverwhere, Wonderland}},
  YEAR = {2017},
  MONTH = Jun,
...
@Misc{cornebize:github_notebook,
  ...
  OPThowpublished = {\url{https://github.com/Ezibenroc/m2_internship_journal}},
