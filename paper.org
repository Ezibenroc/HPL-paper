...
\begin{figure*}[!b]
  \begin{minipage}[t]{.6\linewidth}\null\vspace{-.75em}
    \subfigure[\texttt{dgemm} heterogeneity\label{fig:dgemm_het}]{\includegraphics[width=.45\linewidth]{figures/kernels/dgemm_heterogeneity_calib.png}}\vspace{-1em}%
    \subfigure[\texttt{dgemm} model\label{fig:dgemm_poly}]{\includegraphics[width=.45\linewidth]{figures/kernels/dgemm_model_calib.png}}\vspace{-1em}
    \caption{Illustrating the realism of modeling for BLAS functions.}\vspace{-1em}
    \label{fig:blas_var}
  \end{minipage}\hfill%
  \begin{minipage}[t]{.39\linewidth}
    \subfigure[\texttt{HPL\_dlatcpy} model]{\includegraphics[width=\linewidth]{figures/kernels/dlatcpy_model.png}}\vspace{-1em}
    \caption{Illustrating the realism of modeling for HPL functions.}\vspace{-1em}
    \label{fig:HPL_var}
  \end{minipage}%\vspace{-1em}
\end{figure*}
#+END_EXPORT
