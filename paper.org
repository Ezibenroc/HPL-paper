...
#+RESULTS:
[[file:/tmp/babel-sfW1Yb/figurenXJnMq.png]]
...
lab = lab %>% mutate(label = case_when(model == 'A1'     ~ paste(to_tex('kernels', model(F, F, 1, F, F, 0)), to_tex('network', model(F, T, 1, F, F, 0)), sep='\n'),
                                       ...
                                       model == 'A1het' ~ paste(to_tex('kernels', model(F, F, 1, F, F, 0)), to_tex('dgemm', model(T, F, 1, F, F, 0)), to_tex('network', model(F, T, 1, F, F, 0)), sep='\n'),
                                       model == 'C1het' ~ paste(to_tex('kernels', model(F, F, 1, F, F, 0)), to_tex('dgemm', model(T, F, 2, F, F, 0)), to_tex('network', model(F, T, 1, F, F, 0)), sep='\n'),
                                       model == 'D1het' ~ paste(to_tex('kernels', model(F, F, 1, F, F, 2)), to_tex('dgemm', model(T, F, 2, T, F, 2)), to_tex('network', model(F, T, 1, F, F, 0)), sep='\n'),
                                       model == 'D2het' ~ paste(to_tex('kernels', model(F, F, 1, F, F, 2)), to_tex('dgemm', model(T, F, 2, T, F, 2)), to_tex('network', model(F, T, 1, F, T, 1)), sep='\n'),
...
Running command: '/usr/bin/pdflatex' -interaction=batchmode -halt-on-error -output-directory '/tmp/RtmptXgnmn/tikzDevice1e116a18e595' '/tmp/RtmptXgnmn/tikzDevice1e116a18e595/tikzStringWidthCalc.tex'
