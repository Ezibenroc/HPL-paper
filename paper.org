...
and fixing the core frequencies to 3.7 GHz.

- Compared to the supercomputer runs:
  - a bit easier because (1) fewer ranks (2) more homogeneous
    (3) more stable network
  - a bit harder because (1) loopback vs. IB (2) RAM/Cache contention
    (3) smaller matrix
** Trace
...
\ref{fig:gantt_simulation}). Some more text.
...
\begin{figure}[t]
    ...
    \hline
    N simple
        & \includegraphics[width=0.3\linewidth]{./figures/gantt_charts/gantt_simulation_deterministic-CPU_linear-DGEMM_deterministic-network.png}
        & \includegraphics[width=0.3\linewidth]{./figures/gantt_charts/gantt_simulation_stochastic-CPU_polynomial-DGEMM_deterministic-network.png}
        \\
    \hline
    N complex
        & \includegraphics[width=0.3\linewidth]{./figures/gantt_charts/gantt_simulation_deterministic-CPU_linear-DGEMM_stochastic-network.png}
        & \includegraphics[width=0.3\linewidth]{./figures/gantt_charts/gantt_simulation_stochastic-CPU_polynomial-DGEMM_stochastic-network.png}
        \\
    \hline
    \end{tabular}
...
** Global performance
- With and w/o precise model, all on the same graph
