...
*** Downloading the CSV
These CSV have been generated with this [[https://github.com/Ezibenroc/mpi_calibration/blob/74870b0d26497cf623c47a747e2f089eedb62857/dahu/hpl/hpl_trace_simple.ipynb][notebook]] (the dump to the CSV files
happens in cells 25-26). The notebook uses this [[https://github.com/Ezibenroc/mpi_calibration/blob/74870b0d26497cf623c47a747e2f089eedb62857/dahu/smpi_hpl/grenoble_2019-04-03_1858209.zip][ZIP archive]].
...
plot = ggplot(dgemm, aes(x=m*n*k, y=duration, color=factor(cpu))) + geom_smooth(method='lm')
...
#+RESULTS:
[[file:/tmp/babel-R1JxhR/figureV4WSB1.png]]
...
#+RESULTS:
[[file:/tmp/babel-R1JxhR/figureJC3XvE.png]]
