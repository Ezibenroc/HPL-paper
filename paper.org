...
#+LATEX: \AL{We talk a lot here about why it's challenging and then we say "this is not important"}

** Application Behavior Modeling
SMPI relies on the /online/ simulation approach where the application code is executed and part of
