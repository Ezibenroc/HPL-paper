...
\begin{center}
    ...
    \begin{minipage}[t]{0.35\linewidth}
        ...
        \begin{tabular}{|l|ll|}
            \hline
            \textbf{Dahu} & Node hours & Total gigabytes \\
            \hline
            Reality & \Num{34} & > \Num{2000} \\
            Simulation & \Num{5} & \Num{9} \\
            \hline
        \end{tabular}
        \\ \vspace{0.5 cm} \\
        \begin{tabular}{|l|ll|}
            \hline
            \textbf{Stampede} & Node hours & Total gigabytes \\
            \hline
            Reality & > \Num{12000} & > \Num{120000} \\
            Simulation & \Num{62} & \Num{19} \\
            \hline
        \end{tabular}
    ...
    \begin{minipage}[t]{0.6\linewidth}
        ...
        \captionof{figure}{Dahu's predicted performance is within a few percents of reality\\
