...
\begin{center}
    ...
    \begin{minipage}[t]{0.54\linewidth}
        ...
        \vspace{-.5em}
        \captionof{figure}{HPL performance on Dahu can be predicted within a few percents of reality using a stochastic heterogeneous model for \texttt{dgemm} and a simple model for all other kernels and the nerwork}
...
Xeon Phi would operate at peak performance (see
Figure\ref{fig:stampede_prediction}). Unfortunately, when tracking
