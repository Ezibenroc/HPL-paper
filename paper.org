...
\begin{center}
    ...
    \begin{minipage}[t]{0.3\linewidth}
        \begin{tabular}{l|ll}
             & Node hours & Total gigabytes \\
            \hline
            Reality & 33.7 & > 2000 \\
            Simulation & 4.6 & 9.4 \\
        \end{tabular}
        \captionof{table}{For the largest matrix, simulation is one order of magnitude less expensive than the real execution}
    ...
    \begin{minipage}[t]{0.6\linewidth}
        ...
        \captionof{figure}{The predicted performance lays within a few percents of the reality\\
