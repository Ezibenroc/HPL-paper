...
\begin{figure}[!b]
  \centering
  \vspace{-.5em}
  \includegraphics[width=.9\linewidth,page=1]{./figures/fullscale_unzoomed.png}\vspace{-.5em}
...
@Misc{cornebize:github_notebook,
  ...
  howpublished = {\url{https://github.com/phdstudent/m2_internship_journal}},
  year = 	 {2017},
}
