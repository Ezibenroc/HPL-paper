...
Figure\ref{fig:typical_run} shows the parameters that were used for each of
these runs.
...
$30,000$ showed that $\approx \NSI{96}{\percent}$ of the time is spent in
...
We confirmed that this modification is harmless in terms of
...
matrix of order $80,000$ and $32$ MPI processes, the number of minor
...
certain that that there were only one MPI rank per node. For this
...
cluster of Grid5000. Interestingly spatial and temporal variability
