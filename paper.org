...
#+BEGIN_EXPORT latex
    ...
    \begin{figure*}%[htbp]
      \centering
      \subfigure[Structure of the panel in HPL.\label{fig:panel_structure}]{
        \begin{minipage}[b]{.5\linewidth}
          \begin{tikzpicture}
          ...
          \end{tikzpicture}
        \end{minipage}}%
      \subfigure[Reusing panel allocation from an iteration to another.\label{fig:panel_reuse}]{
        \begin{minipage}[b]{.5\linewidth}
          \begin{center}
          \begin{tikzpicture}
