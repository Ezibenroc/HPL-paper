...
\begin{center}
    ...
    \begin{minipage}[t]{0.48\linewidth}
        ...
        \begin{tabular}{|l|lll|}
            \hline
            \textbf{Dahu} & \# nodes & Node hours & Total gigabytes \\
            \hline
            Reality & \Num{32} & \Num{34} & > \Num{2000} \\
            Simulation & \Num{1} & \Num{5} & \Num{9} \\
            \hline
        \end{tabular}
        \\ \vspace{0.5 cm} \\
        \begin{tabular}{|l|lll|}
            \hline
            \textbf{Stampede} & \# nodes & Node hours & Total gigabytes \\
            \hline
            Reality & \Num{6006} & > \Num{12000} & > \Num{120000} \\
            Simulation & \Num{1} & \Num{62} & \Num{19} \\
            \hline
        \end{tabular}
